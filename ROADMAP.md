# Roadmap Público / Public Roadmap
...
- [x] Adicionar manifesto
- [x] Adicionar diretrizes de segurança
- [x] Adicionar glossário inicial
- [x] Adicionar modelos sanitizados
- [x] Adicionar status e badges no README
...
- [x] Add initial glossary
- [x] Add sanitized templates
- [x] Add README status and badges
